    ...
    $.each(users, function(index, value) {
        $.getJSON(prepareURL("streams", value), function(data) {
            ...
            .fail(function(err) {
                ...
                //innerDiv1.className = "col-md-2";
                failinnerDiv1.classList.add("ultra-xs", "col-xs-offset-1", "col-xs-3", "col-sm-offset-1", "col-sm-2", "col-md-offset-1", "col-md-2");
                //append logo to innerDiv
                ...
                //innerDiv2.className = "col-md-2";
                failinnerDiv2.classList.add("ultra-xs", "col-xs-4", "col-sm-offset-1", "col-sm-3","col-md-offset-1", "col-md-3");
                ...
                //innerDiv3.className = "col-md-2";
                failinnerDiv3.classList.add("ultra-xs", "col-xs-4","col-sm-offset-1", "col-sm-4","col-md-offset-1", "col-md-3");
